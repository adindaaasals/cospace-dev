  ...
  <div class="flex flex-col items-center">
    ...
    <div class="inline-flex rounded-md shadow-lg px-8 md:px-0 xl:px-16" role="group">
      <a href="{{ route('profile') }}">
        <button
          type="button"
          class="rounded-s-lg border border-black bg-transparent px-6 md:px-12 lg:px-20 xl:px-36 py-2 md:py-5 xl:py-3 text-xs md:text-sm  font-medium text-[#079D75] hover:bg-gray-900 hover:text-white focus:z-10 focus:bg-white focus:text-[#079D75]"
        >
          Pengaturan Akun
        </button>
      </a>
      <a href="{{ route('profileReservation') }}">
        <button
          type="button"
          class="border-b border-t border-gray-900 bg-transparent px-8 md:px-12 lg:px-20 xl:px-36 py-2 md:py-5 xl:py-3 text-xs md:text-sm font-medium text-gray-900 hover:bg-gray-900 hover:text-white focus:z-10 focus:bg-gray-900 focus:text-white focus:ring-2 focus:ring-gray-500"
        >
          Reservasi Saya
        </button>
      </a>
      <a href="{{ route('profileBookmark') }}">
        <button
          type="button"
          class="rounded-e-lg border border-gray-900 bg-transparent px-8 md:px-14 lg:px-24 xl:px-40 py-4 md:py-5 text-xs md:text-sm font-medium text-gray-900 hover:bg-gray-900 hover:text-white focus:z-10 focus:bg-gray-900 focus:text-white focus:ring-2 focus:ring-gray-500"
        >
          Bookmark
        </button>
      </a>
